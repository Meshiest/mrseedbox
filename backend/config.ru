...
# stolen from https://github.com/redis-store/redis-rack/blob/master/lib/rack/session/redis.rb
# because the guy didn't allow DIFFERENT HOSTS TO BE USED *facepalm*
module Rack
  module Session
    class Redis < Abstract::ID
      ...
      DEFAULT_OPTIONS = Abstract::ID::DEFAULT_OPTIONS.merge \
        :redis_server => 'redis://redis:6379/0/rack:session'
